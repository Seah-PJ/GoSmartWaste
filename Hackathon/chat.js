...
function handleOption(option) {
    switch(option) {
        case 'checkPoints':
            window.location.href = 'collectionpoints.html'; // Redirect to collectionpoints.html
            break;
        case 'checkSchedule':
            window.location.href = 'collection-schedule.html'; // Redirect to collection-schedule.html
            break;
        case 'reportIssues':
            window.location.href = 'report-issues.html'; // Redirect to report-issues.html
            break;
